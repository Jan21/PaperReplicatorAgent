"""Concept analysis prompt sections and assembled prompt."""

INTRO = (
    "You are doing a COMPREHENSIVE analysis of a research paper to understand its "
    "complete structure, contributions, and implementation requirements."
)
...
ANALYSIS_PROTOCOL = """# COMPREHENSIVE ANALYSIS PROTOCOL
